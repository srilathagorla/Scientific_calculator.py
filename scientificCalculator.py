...
btnBackSpace=Button(calFrame, text="space", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
                    bg="cadetblue",command=added_value.backspace).grid(row=1, column=0,pady=1)

btnClearEntry=Button(calFrame, text=chr(67)+chr(69), height=2,width=6, font=('arial', 16, 'bold'),bd=4, 
...
btntan=Button(calFrame, text="tan", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
                 bg="cadetblue",command=added_value.tan).grid(row=1, column=5, pady=1)

btncos=Button(calFrame, text="cos", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
                 bg="cadetblue",command=added_value.cos).grid(row=1, column=6, pady=1)

btnPi=Button(calFrame, text="pi", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
...
btnsinh=Button(calFrame, text="sinh", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
            command=added_value.sinh     ).grid(row=2, column=4, pady=1)
...
btn2pi=Button(calFrame, text="2pi", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
...
btnE=Button(calFrame, text="e", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
            command=added_value.e     ).grid(row=3, column=4, pady=1)
...
btnasinh=Button(calFrame, text="asinh", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
           command=added_value.asinh      ).grid(row=4, column=4, pady=1)
...
#==============================================================================================
btnlgamma=Button(calFrame, text="lgmma", width=6, height=2,font=('arial', 16, 'bold'),bd=4, 
                 bg="cadetblue",command=added_value.lgamma).grid(row=5, column=4, pady=1)
...
def scientific():
    ...
    lblDisplay= Label(calFrame,text="Dynamic Hunter",font=('C39HrP24DhTt',30),padx=9,
                     fg='cadetblue',justify=CENTER)
